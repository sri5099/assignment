...
export const Hero = () => {
  return (
    <><div className="flex items-center justify-between mb-4">
      <img src="public/assets/image 54.png" alt="Office Illustration" className="w-auto h-auto" />
      <div className="flex items-center border-2 border-[#FFB800] rounded-full px-4 py-2">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#FFB800] mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
